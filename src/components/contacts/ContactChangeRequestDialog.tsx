...
interface ContactChangeRequestDialogProps {
  open: boolean;
...
export function ContactChangeRequestDialog({ open, onOpenChange, contactId, payload, onSuccess }: ContactChangeRequestDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Has realizado modificaciones a este contacto. Por favor, justifica brevemente los cambios solicitados para que un administrador los revise y apruebe.
          </DialogDescription>
        </DialogHeader>
        
        <div className="py-4">
          <Textarea
            placeholder="Ej: Se actualizó el número de teléfono y el cargo..."
            value={justification}
